...
def maquina3(form, host, port, saida_maq3):
	# Valores padroes de cabecalho dos pacotes
    	# Version recebe 2
    	Version = 2
    	# IHL recebe 5 que eh o seu valor padrao
	...
	if form.getvalue('maq3_finger'):
        	Protocol = 3;
        	saida_maq3 += 'Comando FINGER<br><br>'
	...
	if form.getvalue('maq3_uptime'):
        	Protocol = 4;
        	saida_maq3 += 'Comando UPTIME<br><br>'
...
def main():
	...
	print(maquina3(form, host, 9003, saida_maq3))
